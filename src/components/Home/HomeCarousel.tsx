    ...
    return (
        <div className='relative'>
            <div className='relative w-[900px]'>
                ...
                <img src={tmdb_path + carouselMovies[0]?.backdrop_path} className='w-full aspect-[7/4]' alt="" />
            ...
            <div className="absolute bottom-0 flex items-end gap-4 px-4">
                <img src={tmdb_path + carouselMovies[0]?.poster_path} className='w-[160px] aspect-[4/5]' alt="" />
                <div className="flex flex-col gap-1">
                    <h1 className='text-4xl text-white'>{carouselMovies[0]?.title}</h1>
